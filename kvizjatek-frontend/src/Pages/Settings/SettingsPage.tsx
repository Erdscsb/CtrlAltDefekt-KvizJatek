...
const PreviewCard: React.FC<{
  ...
  >
    ...
    >
      <Box sx={{ flex: 1, height: '100%', borderRadius: 1.25, background: `${meta.accent1}22`, border: `1px solid ${meta.accent1}55`, boxShadow: `inset 0 1px 0 rgba(255,255,255,0.05)` }} />
      <Box sx={{ flex: 1, height: '100%', borderRadius: 1.25, background: `${meta.accent2}22`, border: `1px solid ${meta.accent2}55`, boxShadow: `inset 0 1px 0 rgba(255,255,255,0.05)` }} />
      <Box sx={{ flex: 1, height: '100%', borderRadius: 1.25, background: `${meta.text}11`, border: `1px solid ${meta.text}44`, boxShadow: `inset 0 1px 0 rgba(255,255,255,0.05)` }} />
    </Box>
    ...
    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mt: 1.5 }}>
      ...
      {selected && <CheckCircleIcon fontSize="small" sx={{ color: meta.accent1 }} aria-label="Kiválasztva" />}
    </Box>
  </Paper>
);
  ...
  return (
    <Stack alignItems="center" sx={{ mt: 4, width: '100%' }}>
      <Box sx={{ width: '100%', maxWidth: 960, px: 2 }}>
        ...
        {/* FONTOS: ne legyen fix magasság, overflow hidden sehol */}
